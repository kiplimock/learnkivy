...
class MainWidget(RelativeLayout):
    ...
    def init_audio(self):
        self.sound_begin = SoundLoader.load("audio/begin.wav", audio_channel_layout='stereo:2')
        self.sound_galaxy = SoundLoader.load("audio/galaxy.wav", audio_channel_layout='stereo:2')
